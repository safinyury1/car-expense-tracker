                    ...
                    <form method="GET" action="{{ route('expenses.index') }}" class="space-y-4">
                        <div class="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                            ...
                            <div class="flex-1 min-w-[160px]">
                                ...
                                <div class="relative">
                                    <select name="category_id" class="w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg shadow-sm text-sm pl-3 pr-8 py-2.5 appearance-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
