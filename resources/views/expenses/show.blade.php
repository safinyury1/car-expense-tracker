<x-app-layout>
                        ...
                        <div class="pt-4 border-t border-gray-100 dark:border-gray-700">
                            <div class="flex justify-between items-center mb-3">
                                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Прикреплённые файлы ({{ $expense->attachments->count() }}/4)
                                </h4>
                                @if($expense->attachments->count() < 4)
                            ...
                            <form id="addAttachmentForm" action="{{ route('expenses.add-attachment', $expense) }}" 
    ...
    <script>
        ...
        document.getElementById('addAttachmentInput').addEventListener('change', function(e) {
            ...
            const currentCount = {{ $expense->attachments->count() }};
            const maxFiles = 4;
