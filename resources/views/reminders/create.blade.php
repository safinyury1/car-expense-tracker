                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('reminders.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Пример: Замена масла, Замена ремня ГРМ, Шиномонтаж..." class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm" required>
                            @error('title')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="due_odometer" id="due_odometer" value="{{ old('due_odometer') }}" min="0" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="due_date" id="due_date" value="{{ old('due_date') }}" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm">
