<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <a href="{{ route('reminders.index', ['car_id' => $selectedCar]) }}" 
        ...
        <div class="max-w-2xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-[#222222] overflow-hidden shadow-sm rounded-xl">
                <div class="p-5 sm:p-7 md:p-8">
                    ...
                    <form action="{{ route('reminders.store') }}" method="POST" class="space-y-5 sm:space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Напоминание появится, когда пробег достигнет этого значения</p>
                                @error('due_odometer')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
