            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if($reminders->isEmpty())
                        <p class="text-gray-500">У вас пока нет добавленных напоминаний. Нажмите кнопку выше, чтобы добавить.</p>
                    @else
                            ...
                            <tbody>
                                @foreach($reminders as $reminder)
                                    <tr class="border-b {{ $reminder->is_completed ? 'bg-gray-50' : '' }}">
                                        ...
                                        <td class="px-4 py-2">
                                            <a href="{{ route('reminders.edit', $reminder) }}" class="text-blue-600 hover:text-blue-900 mr-3">Ред.</a>
