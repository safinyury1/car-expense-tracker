                ...
                <form action="{{ route('incomes.update', $income) }}" method="POST">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="number" name="odometer" id="odometer" value="{{ old('odometer', $income->odometer) }}" min="0" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm">
