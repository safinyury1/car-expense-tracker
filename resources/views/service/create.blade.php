            ...
            <div class="bg-white dark:bg-[#222222] rounded-2xl shadow-sm overflow-hidden">
                <form action="{{ route('service.store') }}" method="POST">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" 
                                   ...
                                   class="w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg shadow-sm" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="odometer" value="{{ old('odometer') }}" 
                                   ...
                                   class="w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg shadow-sm @error('odometer') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="cost" value="{{ old('cost') }}" step="0.01"
                                   ...
                                   class="w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg shadow-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="3" placeholder="Дополнительная информация..."
                                      class="w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg shadow-sm">{{ old('notes') }}</textarea>
                        </div>
                        
                        <div class="border-t border-gray-200 dark:border-gray-700 my-4"></div>
                        
                        <!-- Следующее ТО (синий блок без анимации) -->
                        <div class="bg-blue-500 dark:bg-blue-600 rounded-lg p-4 ">
                            <h3 class="font-medium text-white mb-3">Следующее ТО</h3>
                            
                            <div class="space-y-3">
                                <div>
                                    <label class="block text-sm font-medium text-white mb-1">Следующая замена (пробег)</label>
                                    <input type="number" name="next_due_odometer" 
                                           placeholder="Пробег для следующего ТО"
                                           class="w-full border-white/30 dark:border-white/30 dark:bg-[#6B727F] dark:text-white rounded-lg shadow-sm">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-white mb-1">Следующая замена (дата)</label>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-600 flex justify-between items-center">
                        <a href="{{ route('overview.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg transition">
                            Назад
                        </a>
