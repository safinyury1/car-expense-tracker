        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400">Общие расходы</p>
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ number_format($data['totalExpenses'], 2) }} ₽</p>
                    </div>
                </div>
                
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400">Затраты на топливо</p>
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ number_format($data['totalFuelCost'], 2) }} ₽</p>
                    </div>
                </div>
                
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400">Средний расход топлива</p>
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $data['avgFuelConsumption'] }} <span class="text-sm font-normal">л/100 км</span></p>
                    </div>
                </div>
                
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400">Стоимость 1 км</p>
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ number_format($data['costPerKm'], 2) }} ₽</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 border-b border-gray-100 dark:border-gray-700 dark:border-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-4">
                        <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ number_format($insights['dailyAverage'], 2) }} ₽</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400 mt-1">в среднем за день</p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-4">
                        <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ number_format($insights['averageExpense'], 2) }} ₽</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400 mt-1">за одну операцию</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-400">{{ $expense['date'] }} • {{ number_format($expense['odometer']) }} км</p>
                            ...
                            <div class="text-right">
                                <p class="text-xl font-bold text-red-600 dark:text-red-400">{{ number_format($expense['amount'], 2) }} ₽</p>
                                <p class="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-400">{{ $expense['category'] }}</p>
                            </div>
                        </div>
                    @empty
                        <div class="p-8 text-center text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-400">
