<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="mb-4">
            <x-input-label for="name" :value="__('Имя')" class="text-gray-700 dark:text-gray-300" />
            <x-text-input id="name" class="block mt-1 w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg focus:ring-blue-500 focus:border-blue-500" 
        ...
        <div class="mb-6">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full border-gray-300 dark:border-gray-600 dark:bg-[#6B727F] dark:text-white rounded-lg focus:ring-blue-500 focus:border-blue-500"
                            type="password"
