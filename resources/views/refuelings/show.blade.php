<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <a href="{{ route('refuelings.index', ['car_id' => $refueling->car_id]) }}" 
            ...
            <div class="bg-white dark:bg-[#222222] overflow-hidden shadow-sm rounded-xl">
                <div class="p-5 sm:p-7 md:p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- ========================================== -->
                        <!-- ВЛОЖЕНИЯ (ЧЕКИ) С ВОЗМОЖНОСТЬЮ ДОБАВЛЕНИЯ -->
                        <!-- ========================================== -->
                        <div class="pt-4 border-t border-gray-100 dark:border-gray-700">
                            <div class="flex justify-between items-center mb-3">
                                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Прикреплённые файлы ({{ $refueling->attachments->count() }}/4)
                                </h4>
                                @if($refueling->attachments->count() < 4)
                            ...
                            <!-- Форма для добавления файла (скрытая) -->
                            <form id="addAttachmentForm" action="{{ route('refuelings.add-attachment', $refueling) }}" 
                            ...
                            <!-- Список файлов -->
                            @if($refueling->attachments && $refueling->attachments->count() > 0)
