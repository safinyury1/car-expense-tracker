<x-app-layout>
    ...
    <a href="{{ route('overview.index', ['car_id' => $refueling->car_id]) }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded transition">
        Назад
    </a>
    <div class="flex gap-2">
        <a href="{{ route('refuelings.edit', $refueling) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded transition">
            Редактировать
        </a>
