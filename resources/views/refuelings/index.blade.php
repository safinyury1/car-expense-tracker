            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                        ...
                        <form method="GET" action="{{ route('refuelings.index') }}" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="search" value="{{ $search }}" placeholder="АЗС, автомобиль..." class="w-full border-gray-300 rounded-md shadow-sm">
                                </div>
                    ...
                    @if($refuelings->isEmpty())
                        <p class="text-gray-500 text-center py-8">Нет данных по заданным фильтрам.</p>
                    @else
                                ...
                                <tbody>
                                    @foreach($refuelings as $refueling)
                                        <tr class="border-b hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-2 text-sm text-gray-500">{{ $refueling->gas_station ?: '—' }}</td>
                                            <td class="px-4 py-2">
                                                <a href="{{ route('refuelings.edit', $refueling) }}" class="text-blue-600 hover:text-blue-900 mr-3"></a>
