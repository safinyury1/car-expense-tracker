                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('refuelings.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date" id="date" value="{{ old('date', date('Y-m-d')) }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                            @error('date')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="liters" id="liters" value="{{ old('liters') }}" step="0.01" min="0" class="w-full border-gray-300 rounded-md shadow-sm" required>
                            @error('liters')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="price_per_liter" id="price_per_liter" value="{{ old('price_per_liter') }}" step="0.01" min="0" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="gas_station" id="gas_station" value="{{ old('gas_station') }}" class="w-full border-gray-300 rounded-md shadow-sm">
                            @error('gas_station')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
